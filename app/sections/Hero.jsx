...
//       <div className="w-full mx-auto flex flex-col sm:mt-50 mt-5 c-space gap-3">
//         <p className="sm:text-3xl text-xl font-medium text-white text-center font-generalsans mt-28">
...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen w-full flex flex-col relative" id="home">
      <div className="w-full mx-auto flex flex-col sm:mt-36 mt-20 c-space gap-3 lg:pb-9">
